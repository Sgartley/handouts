...
sorted <-select(animals_DM,sex, weight)
...
year_wgt +
  scale_color_manual(values=c("dark blue", "yellow"))
...
ggplot(data=animals_common, aes(x=weight, fill=species_id:sex,))+geom_histogram(aes(y=..density..))+
   facet_grid(sex~species_id)+
   labs(title ="Weight of most common species", x="Sex", y="Weight (g)")+ guides(fill=FALSE)
